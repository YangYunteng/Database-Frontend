  ...
  <div id="base_register">
    <el-form :model="registerForm" :rules="rules" class="register_container" label-position="left"
      ...
      <el-form-item prop="jobNumber">
        <el-input type="text" v-model="registerForm.jobNumber"
                  auto-complete="off" placeholder="jobNumber"></el-input>
      </el-form-item>
      ...
      <el-form-item style="width: 100%">
        <el-button type="primary" style="width: 40%;background: #afb4db;border: none"
    ...
    data() {
      ...
      return {
        ...
        rules: {
          ...
          jobNumber: [{required: true, message: '', trigger: 'blur'}, {validator: dataValid, trigger: 'blur'}],
        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            this.$axios.post('/register', {
                ...
                jobNumber: this.registerForm.jobNumber
              }
            )
              .then(resp => {
                // 根据后端的返回数据修改
